...
from traffic_vision.components.data_ingestion import DataIngestion
from traffic_vision.components.data_validation import DataValidation
from traffic_vision.components.model_trainer import ModelTrainer
from traffic_vision.components.model_evaluation import ModelEvaluation


from traffic_vision.entity.config_entity import (DataIngestionConfig,
                                                 DataValidationConfig,
                                                 ModelTrainerConfig,
                                                 ModelEvaluationConfig)

from traffic_vision.entity.artifacts_entity import (DataIngestionArtifact,
